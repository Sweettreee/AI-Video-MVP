...
동작: (캐릭터의 구체적 신체 동작 + 자세를 하나로 묘사 — "마이크를 높이 든 채 한쪽 무릎을 꿇고 관객을 올려다본다" 처럼 동사+자세+방향 포함)
포즈: (캐릭터의 자세/체형 묘사)
...
- 동작 필드는 "~한다" 형태로 끝나는 구체적 행동 서술이며, 포즈와 신체 동작을 통합하여 서술할 것 (별도의 포즈 필드와 중복되더라도, 동작 필드만으로 이미지를 그릴 수 있도록. 예: "마이크를 높이 든 채 한쪽 무릎을 꿇고 관객을 올려다본다")
